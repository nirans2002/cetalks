...
//   @override
//   _FlutterPollsState createState() => _FlutterPollsState();
// }
...
//                 ),
//                 Text(
//                     PollMath.getMainPerc(this.v1, this.v2, this.v3, this.v4, 1)
//                             .toString() +
//                         "%",
//                     style: this.highest == this.v1
//                         ? widget.leadingPollStyle
...
//             lineHeight: 38.0,
//             animationDuration: 500,
//             percent: PollMath.getPerc(this.v1, this.v2, this.v3, this.v4, 2)[0],
//             center: Row(
//               mainAxisAlignment: MainAxisAlignment.spaceBetween,
//               children: <Widget>[
//                 Row(
...
//                 ),
//                 Text(
//                     PollMath.getMainPerc(this.v1, this.v2, this.v3, this.v4, 2)
//                             .toString() +
//                         "%",
//                     style: this.highest == this.v2
//                         ? widget.leadingPollStyle
